...
scrollMinetoY = (y) ->
	...
	text1.y = Utils.modulate(y,[30,160],[84,48],true)
# 	text1.x = Utils.modulate(y,[0,40],[72,100],true)
	...
	text2.y = Utils.modulate(y,[30,160],[84,48],true)
# 	text2.x = Utils.modulate(y,[0,40],[Screen.width/2-60,Screen.width/2-30],true)
	...
	lineMine.x = Utils.modulate(y,[0,40],[Screen.width/2-14,Screen.width/2],true)
...
# 	icon3.scale = Utils.modulate(y,[0,40],[1,0.8],true)
	...
	scrollMine.y = Utils.modulate(y,[0,172],[446,228],true)
...
scrollInvesttoY = (y) ->
	for i in [amounts-4...amounts]
		...
		scrollInvest.content.children[2].children[i].children[9].width = Utils.modulate(y,[252*i-917,252*(i+1)-917],[0,358],true)
	for i in [0...amounts-4]
			#if y<152
		scrollInvest.content.children[0].children[i].children[9].width = Utils.modulate(y,[252*i+120,252*(i+1)+120],[358,0],true)
		scrollInvest.content.children[1].children[i].children[9].width = Utils.modulate(y,[252*i,252*(i+1)],[358,0],true)
		scrollInvest.content.children[2].children[i].children[9].width = Utils.modulate(y,[252*i,252*(i+1)],[358,0],true)
...
scrollInvest.content.draggable.on Events.DragStart, ->
# scroll.onMove ->
	fab.states.switch("on")	
# 	fabFadeout.start()
	
scrollInvest.content.draggable.on Events.DragEnd, ->
# 	fabFadein.start()
# 	else
	Utils.delay 1.2, ->
...
content2.parent = scrollInvest.content
content2.x = Screen.width

content3 = content2.copy()
content3.parent = scrollInvest.content
...
scrollInvest.content.children[1].children[amounts].children[0].html = "<span style='font-size:26px;padding:14px 32px;overflow:hidden;line-height:1.4;color:#FD8608'>投资特色 : 期限短，收益快。</span>"

scrollInvest.content.children[2].children[amounts].children[0].html = "<span style='font-size:26px;padding:14px 32px;overflow:hidden;line-height:1.4;color:#FD8608'>投资特色 : 二级市场，灵活买卖。</span>"

for i in [0...amounts]
	scrollInvest.content.children[1].children[i].children[0].html = "<span style='font-size:32px;color:#212121;padding:16px 32px;line-height:3'>诺诺盈</span>"
	scrollInvest.content.children[2].children[i].children[0].html = "<span style='font-size:32px;color:#212121;padding:16px 32px;line-height:3'>急用钱</span>"
# 	scrollInvest.content.children[1].children[i].children[9].width = 0
